...
var G = class {
  constructor(t, e, n, r) {
    this.t = t, this.i = e, this.o = n, this.u = r, this.type = "FirstParty", this.user = l.FIRST_PARTY, this.h = /* @__PURE__ */ new Map();
  }
  l() {
    return this.u ? this.u() : (v(!("object" != typeof this.t || null === this.t || !this.t.auth || !this.t.auth.getAuthHeaderValueForFirstParty)), this.t.auth.getAuthHeaderValueForFirstParty([]));
  }
  get headers() {
...
var wt = class extends class {
  ...
  v(t, e, n, r, s) {
    ...
    const o = {};
    return this.I(o, r, s), this.A(t, i, o, n).then((t2) => (m("RestConnection", "Received: ", t2), t2), (e2) => {
...
var Zt = class extends class {
  ...
  static create(t, e, n) {
    return t.isKeyField() ? "in" === e || "not-in" === e ? this.$(t, e, n) : new te(t, e, n) : "array-contains" === e ? new se(t, n) : "in" === e ? new ie(t, n) : "not-in" === e ? new oe(t, n) : "array-contains-any" === e ? new ue(t, n) : new Zt(t, e, n);
  }
  static $(t, e, n) {
  ...
  matches(t) {
    ...
    return "!=" === this.op ? null !== e && this.F(Ut(e, this.value)) : null !== e && Ct(this.value) === Ct(e) && this.F(Ut(e, this.value));
  }
  F(t) {
    switch (this.op) {
      case "<":
...
function pe(t) {
  ...
  if (null === e.q) {
    ...
    if (null !== t2 && null === n)
      t2.isKeyField() || e.q.push(new ae(t2)), e.q.push(new ae(tt.keyField(), "asc"));
    else {
      let t3 = false;
      ...
      if (!t3) {
        ...
        e.q.push(new ae(tt.keyField(), t4));
      }
    }
  }
  return e.q;
...
function ye(t) {
  ...
  if (!e.O)
    if ("F" === e.limitType)
      e.O = Xt(e.path, e.collectionGroup, pe(e), e.filters, e.limit, e.startAt, e.endAt);
    else {
      const t2 = [];
      ...
      e.O = Xt(e.path, e.collectionGroup, t2, e.filters, e.limit, n, r);
    }
  return e.O;
}
function _e(t, e) {
...
var tn = class {
  constructor(t, e, n = 1e3, r = 1.5, s = 6e4) {
    this.M = t, this.timerId = e, this.U = n, this.j = r, this.B = s, this.G = 0, this.W = null, this.K = Date.now(), this.reset();
  }
  reset() {
    this.G = 0;
  }
  ...
  H(t) {
    ...
    r > 0 && m("ExponentialBackoff", `Backing off for ${r} ms (base delay: ${this.G} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), this.W = this.M.enqueueAfterDelay(this.timerId, r, () => (this.K = Date.now(), t())), this.G *= this.j, this.G < this.U && (this.G = this.U), this.G > this.B && (this.G = this.B);
  }
  X() {
...
var en = class extends class {
  ...
  constructor(t, e, n, r) {
    super(), this.authCredentials = t, this.appCheckCredentials = e, this.Z = n, this.C = r, this.tt = false;
  }
  et() {
    if (this.tt)
  ...
  v(t, e, n) {
    return this.et(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([r, s]) => this.Z.v(t, e, n, r, s)).catch((t2) => {
  ...
  R(t, e, n, r) {
    return this.et(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([s, i]) => this.Z.R(t, e, n, s, i, r)).catch((t2) => {
      throw "FirebaseError" === t2.name ? (t2.code === D && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t2) : new L(I, t2.toString());
    });
  }
  terminate() {
...
async function nn(t, e) {
  const n = b(t), r = Be(n.C) + "/documents", s = {
    writes: e.map((t2) => We(n.C, t2))
  };
  await n.v("Commit", r, s);
}
async function rn(t, e) {
  const n = b(t), r = Be(n.C) + "/documents", s = {
    documents: e.map((t2) => Me(n.C, t2))
  }, i = await n.R("BatchGetDocuments", r, s, e.length), o = /* @__PURE__ */ new Map();
  i.forEach((t2) => {
    const e2 = Ge(n.C, t2);
...
var an = class {
  constructor(t, e, n, r) {
    this._authCredentials = t, this._appCheckCredentials = e, this._databaseId = n, this._app = r, this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new cn({}), this._settingsFrozen = false;
  }
  get app() {
    if (!this._app)
  ...
  _setSettings(t) {
    ...
    this._settings = new cn(t), void 0 !== t.credentials && (this._authCredentials = function(t2) {
      ...
      switch (t2.type) {
        case "gapi":
          const e = t2.client;
          return new W(e, t2.sessionIndex || "0", t2.iamToken || null, t2.authTokenFactory || null);
        case "provider":
          return t2.client;
        default:
...
function gn(t, e, ...n) {
  if (t = getModularInstance(t), 1 === arguments.length && (e = pt.N()), nt("doc", "path", e), t instanceof an) {
    const r = X.fromString(e, ...n);
    return rt(r), new wn(
      t,
      null,
...
var $n = class {
  constructor(t, e, n, r, s, i) {
    this.settings = t, this.databaseId = e, this.C = n, this.ignoreUndefinedProperties = r, void 0 === s && this.nt(), this.fieldTransforms = s || [], this.fieldMask = i || [];
  }
  get path() {
  ...
  ht(t) {
    return Jn(t, this.settings.methodName, this.settings.lt || false, this.path, this.settings.ft);
  }
  contains(t) {
...
var Cn = class extends An {
  ...
  _toFieldTransform(t) {
    const e = On(
      ...
      t,
      true
    ), n = this.wt.map((t2) => zn(t2, e)), r = new Ee(n);
...
var Ln = class extends An {
  ...
  _toFieldTransform(t) {
    const e = On(
      ...
      t,
      true
    ), n = this.wt.map((t2) => zn(t2, e)), r = new Te(n);
    return new Ae(t.path, r);
  }
  isEqual(t) {
    return this === t;
...
function jn(t, e, n, r, s, i) {
  const o = t.dt(1, e, n), u = [Qn(e, r, n)], c = [s];
  if (i.length % 2 != 0)
...
function zn(t, e) {
  ...
  return function(t2, e2) {
    ...
    if (t2 instanceof In)
      return {
        bytesValue: Oe(e2.C, t2._byteString)
      };
    if (t2 instanceof wn) {
    ...
    throw e2.ht(`Unsupported field value: ${it(t2)}`);
  }(t, e);
}
function Gn(t, e) {
  const n = {};
...
var Lr = class {
  ...
  precondition(t) {
    ...
    return !this.writtenDocs.has(t.toString()) && e ? e.isEqual(vt.min()) ? Re.exists(false) : Re.updateTime(e) : Re.none();
  }
...
var zr = class {
  constructor() {
    this.xt = Promise.resolve(), this.Ft = [], this.St = false, this.qt = [], this.Ot = null, this.kt = false, this.Ct = false, this.Lt = [], this.Pt = new tn(this, "async_queue_retry"), this.Mt = () => {
      const t2 = jr();
      t2 && m("AsyncQueue", "Visibility state changed to " + t2.visibilityState), this.Pt.X();
    };
    const t = jr();
  ...
  async Bt() {
    if (0 !== this.Ft.length) {
      ...
      this.Ft.length > 0 && this.Pt.H(() => this.Bt());
    }
  }
  jt(t) {
  ...
  enqueueAfterDelay(t, e, n) {
    ...
    const r = Br.createAndSchedule(this, t, e, n, (t2) => this.zt(t2));
...
!function(t) {
  ...
  const r = t.getProvider("app").getImmediate(), s = new an(new z(t.getProvider("auth-internal")), new Q(t.getProvider("app-check-internal")), function(t2, e2) {
    ...
    return new H(t2.options.projectId, e2);
  }(r, e), r);
  return n && s._setSettings(n), s;
}, "PUBLIC").setMultipleInstances(true)), registerVersion("firestore-lite", "3.4.15", ""), registerVersion("firestore-lite", "3.4.15", "esm2017");
export {
  In as Bytes,
